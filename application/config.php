...
return [
    ...
    'log'                    => [
        ...
        'path'  => LOG_PATH,
        // 日志记录级别（插件会合并自定义级别）
        'level' => ['PAY_API','REPAY_API','API','REPAY_ERROR','PAY_ERROR','PAY_CHANNEL','REPAY_CHANNEL','REPAY_NOTIFY','PAY_NOTIFY'],
        // 需要单独记录到独立文件的级别（支持自定义级别）
        'apart_level' => ['PAY_API','REPAY_API','API','REPAY_ERROR','PAY_ERROR','PAY_CHANNEL','REPAY_CHANNEL','REPAY_NOTIFY','PAY_NOTIFY'],
    ],
    // +----------------------------------------------------------------------
...
//分页配置
    ...
    'token'                  => [
        ...
        'type'     => 'Mysql',
        // 缓存前缀
        'key'      => '4BmfIuiPlKnhborZCWE18sMAg0JRH5Gj',
        // 加密方式
        'hashalgo' => 'ripemd160',
        // 缓存有效期 0表示永久缓存
        'expire'   => 0,
    ...
    //用户配置
    'user'                   => [
        // Token有效时长，单位：秒，默认2592000（30天）
        // 可根据需要调整：7天=604800，15天=1296000，30天=2592000，90天=7776000
        'keeptime' => 10800,
    ],
    //FastAdmin配置
    'fastadmin'              => [
