...
class Account extends Backend
{
    ...
    /**
     * Account模型对象
     * @var \app\admin\model\mq\Account
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\mq\Account;
        ...
        // 获取通道下拉列表
        $channelList = \app\admin\model\mq\Channel::column('name', 'id');
