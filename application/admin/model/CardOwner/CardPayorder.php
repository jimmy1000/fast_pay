...
class CardPayorder extends Model
{
    ...
    {
        return ['pending' => __('Pending'), 'success' => __('Success'), 'failed' => __('Failed'), 'closed' => __('Closed'), 'refunded' => __('Refunded')];
    }
